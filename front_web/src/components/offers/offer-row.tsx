...
export function OfferRow({
  ...
  const hasRoute =
    offer.route !== undefined &&
    offer.route?.origin !== "À préciser" &&
    offer.route?.destination !== "À préciser";
  ...
  return (
    ...
    >
      ...
      {/* Offre */}
      <td className="p-3.5 w-[200px] sm:w-[250px] lg:w-[300px] max-w-[300px]">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div
              className="font-mono text-xs text-gray-500 mt-0.5 truncate"
              title={offer.name}
            >
              {offer.name}
            </div>
