...
export function Adresse() {
  return (
    <div className="bg-white rounded-xl border border-[#DDE5EF] mb-4 overflow-hidden">
      ...
      <div className="p-5">
        <div className="mb-4">
          <div className="font-inter text-xs font-medium text-[#435869] mb-1.5">Adresse</div>
          <input 
            type="text" 
            value="Avenue Cheikh Anta Diop, Dakar Plateau"
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <div className="font-inter text-xs font-medium text-[#435869] mb-1.5">Ville</div>
            <input 
              type="text" 
              value="Dakar"
              className="w-full h-9 px-2.5 border border-[#DDE5EF] rounded-lg bg-white text-[#2E3D4C] font-inter text-[13px] focus:outline-none focus:border-primary focus:shadow-[0_0_0_3px_rgba(0,118,73,0.1)]"
          ...
          <div>
            <div className="font-inter text-xs font-medium text-[#435869] mb-1.5">Code postal</div>
            <input 
              type="text" 
              value="10700"
              className="w-full h-9 px-2.5 border border-[#DDE5EF] rounded-lg bg-white text-[#2E3D4C] font-inter text-[13px] focus:outline-none focus:border-primary focus:shadow-[0_0_0_3px_rgba(0,118,73,0.1)]"
        ...
        <div>
          <div className="font-inter text-xs font-medium text-[#435869] mb-1.5">Pays</div>
