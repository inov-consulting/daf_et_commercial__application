...
const integrationsData: Integration[] = [
  ...
  { id: 'dropbox', name: 'Dropbox Business', description: 'Archivage automatique des CR vocaux et documents', category: 'Stockage', icon: '📦', status: 'connected' as const, meta: '/Altus/CRM/Archives', lastSync: 'il y a 1 heure' },
