...
export function ApiKeysBlock({ showToast }: ApiKeysBlockProps) {
  return (
    <div className="bg-white border border-[#DDE5EF] rounded-lg p-4 mt-4">
      <div className="font-space-grotesk text-[13px] font-semibold text-[#1B2633]">Clés API Altus</div>
      <div className="font-inter text-xs text-[#7691A8] mb-3">Pour accéder à l&apos;API Altus depuis vos applications tierces</div>
