...
const tabs: { id: TabKey; label: string; icon: React.ReactNode; badge?: string }[] = [
    { id: 'agents', label: 'Agents IA', icon: <ShieldCheck size={16} weight="bold" />, badge: '4 agents' },
    { id: 'profil', label: 'Profil entreprise', icon: <Question size={16} weight="bold" /> },
    { id: 'notifs', label: 'Notifications', icon: <Bell size={16} weight="bold" /> },
    { id: 'integ', label: 'Intégrations', icon: <Plug size={16} weight="bold" /> },
    { id: 'billing', label: 'Facturation', icon: <CreditCard size={16} weight="bold" /> },
];
