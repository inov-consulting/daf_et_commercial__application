...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "whatsapp_messages" ADD "media_url" VARCHAR(1000);"""
...
MODELS_STATE = (
    ...
    "61YS+qTgTCk8RdMMX5XsJapb7K2a+x9KQr3EEvpXyy7a2EcVcIIuKuwZYQSEQ9dkUpU2hs"
    "09GzaBVtM54QtL3/ivEO3lWNm87kY4ZxyQchTTeG2cS1noSCNcUhAyTqDTGSuCveyKW+G4"
    "BRtPFdH6na2SmMn0JM2+qi2sxk10EN4Ehf+vsB1MMx2AQtQcc1BCpYqm9lEHDXsbOwvos8"
    "ceKHpOl44+GBNO7aeBwpWT3Rk2uW/wqkxnIt1qdbO2UcdZK+7VaL4Rjaze6SB6pKa9vCDS"
    "U+vuu3dtKMK7d/UcQdyTQjMCBX9uiMkIVIS5JwBuxWBWe3pzU7RW3enNO4vU6r5Cu9dI6t"
    "//HyDStjU="
)
